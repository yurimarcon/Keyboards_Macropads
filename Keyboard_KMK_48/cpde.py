...
keyboard.keymap = [
    ...
    # |XXXXXX|XXXXXX|------+------+------+------+------+------+------+------+------+------+------+------|
    # |XXXXXX|XXXXXX| Shift|   Z  |   X  |   C  |   V  |   B  |   N  |   M  |   ,  |   .  |   /  | Enter|
    # |XXXXXX|XXXXXX|------+------+------+------+------+------+------+------+------+------+------+------|
    # |XXXXXX|XXXXXX| Ctrl | GUI  |  Alt |XXXXXX|  Fn2 | Space| Space|  Alt |  Fn  |XXXXXX|XXXXXX|XXXXXX|
    # `-------------------------------------------------------------------------------------------------'
    [
        ...
        XXXXXXX, XXXXXXX, KC.LSFT,  KC.Z,    KC.X,    KC.C,    KC.V,    KC.B,    KC.N,    KC.M,    KC.COMM, KC.DOT,  KC.SLSH, XXXXXXX,   
        XXXXXXX, XXXXXXX, KC.LCTRL, KC.LGUI, KC.LALT, XXXXXXX, FN2,     KC.SPC,  KC.SPC,  KC.RALT, FN,      XXXXXXX, XXXXXXX, KC.ENTER,  
    ],
    # Alt
    # ,-------------------------------------------------------------------------------------------------.
    # |XXXXXX|XXXXXX|XXXXXX|XXXXXX|XXXXXX|XXXXXX|XXXXXX|XXXXXX|XXXXXX|XXXXXX|XXXXXX|XXXXXX|XXXXXX|XXXXXX|
