...
keyboard.keymap = [
    ...
    # |XXXXXX|XXXXXX|------+------+------+------+------+------+------+------+------+------+------+------|
    # |XXXXXX|XXXXXX| Ctrl | GUI  |  Alt | Fn2  |  Fn2 | Space| Space|  Alt |  Fn  |XXXXXX|XXXXXX|XXXXXX|
    # `-------------------------------------------------------------------------------------------------'
    [
        ...
        XXXXXXX, XXXXXXX, KC.LCTRL, KC.LGUI, KC.LALT, FN2,     FN2,     KC.SPC,  KC.SPC,  KC.RALT, FN,      XXXXXXX, XXXXXXX, KC.ENTER,  
    ],
    # Alt
    # ,-------------------------------------------------------------------------------------------------.
    # |XXXXXX|XXXXXX|XXXXXX|XXXXXX|XXXXXX|XXXXXX|XXXXXX|XXXXXX|XXXXXX|XXXXXX|XXXXXX|XXXXXX|XXXXXX|XXXXXX|
